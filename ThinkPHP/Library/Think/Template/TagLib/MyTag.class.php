...
class MyTag extends TagLib{
	...
	protected $tags   =  array(
		...
		'comment'   => array('attr' => 'limit', 'close' => 0), //评论
	);
	...
	public function _comment($tag, $content){
		...
		$parse='<iframe id="comment" scrolling="no" frameborder="0" style="height: 571px; display: block !important; width: 100% !important; border: 0px none !important; overflow: hidden !important;" src="/index.php?s=/Home/Comment/index/id/{$id}/limit/'.$limit.'"></iframe>';
		return $parse;
	}
