...
<div class="content bgcolor-fff play-header" style="display: none;" name="play-header">
    <div class="container">
		...
		<div class="content margin-t30">
			<div class="container">
				<div class="col col77 bgcolor-fff padding vl-align-top">
					<?php $__NEWS__ = D('Tag')->newspage($cid, "update_time desc","15", 1,"true"); if(is_array($__NEWS__)): $i = 0; $__LIST__ = $__NEWS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newlist): $mod = ($i % 2 );++$i;?><a href="<?php echo ($newlist['url']); ?>" class="col col12 padding-tb15 border-bottom" name="NewsList">
							<div class="col col3 newimg vl-align-top">
								<img src="<?php echo ($newlist['pic']); ?>" class="img-full">
							</div>
							<div class="col col9 vl-align-top">
								<h1 class="f18"><?php echo ($newlist['title']); ?></h1>
								<div class="col col12 f12 h88 margin-t8">
									<?php echo msubstr(strip_tags($newlist['content']),0,120);?>
								</div>
								<div class="col col12 f12 hdd margin-t15"><?php echo ($newlist['time']); ?></div>
							</div>
						</a><?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				<div class="col col33 f14 bgcolor-fff vl-align-top padding">
					<div class="col col12">
						<h3 class="public_title"><span>资讯排行榜</span></h3>
                    </div>
					<div class="col col12 margin-t15 rank">
						<?php $__NEWS__ = D('Tag')->news($cid, "hits desc","10", 1,"true"); if(is_array($__NEWS__)): $i = 0; $__LIST__ = $__NEWS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newlist): $mod = ($i % 2 );++$i;?><dl class="col col12 rank-list">
                            <a href="<?php echo ($newlist['url']); ?>">
                                <dd><?php echo ($i); ?></dd>
                                <dt class="text-left"><?php echo ($newlist['title']); ?></dt>
                                <img src="<?php echo ($newlist['pic']); ?>" class="img-full">
                            </a>
...
<script type="text/javascript" src="<?php echo ($tplpath); ?>/js/template/global.js"></script>
		...
		$(document).ready(function(){
			$('[name="NewsList"]').each(function() {
				var Timgsrc = $(this).children('.newimg').children('img').attr('src');
				if (Timgsrc==""){
					$(this).children('.newimg').hide();
				}
			});
		});
		</script>
