...
<div class="content bgcolor-fff play-header" style="display: none;" name="play-header">
    <div class="container">
		...
		<div class="content margin-t30">
			<div class="container">
				<div class="col col12">
					<div class="ad-height col col12">
						<script src="/Public/Ad/type_1180x100.js"></script>
					</div>
				</div>
				<div class="col col12 margin-t30 color-line">
					<h3 class="public_title"><span>最新更新</span></h3>
				</div>
				<div class="col col12 move-list">
					<?php $__LIST__ = D('Tag')->listspage($cid, "update_time desc","48", 1,"true"); if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="col col26">
						<a href="<?php echo ($list['url']); ?>">
							...
							<div class="list-img">
								...
								<img src="<?php echo ($list['pic']); ?>" class="img-full">
								<small>
									<?php echo (msubstr($list['actors'],0,11)); ?>
								</small>
							</div>
