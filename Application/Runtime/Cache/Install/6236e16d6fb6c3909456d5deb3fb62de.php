...
<html>
    ...
    <?php
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_PORT', '3306'); defined('SAE_MYSQL_DB') or define('SAE_MYSQL_DB', 'lfdycms'); ?>
    <h1>创建数据库</h1>
    <form action="/install.php?s=/install/step2.html" method="post" target="_self" class="form-horizontal">
            ...
            <div class="form-group">
            	<div class="col-xs-3">
                <input type="text" name="db[]" class="form-control" value="lf_">
                </div>
