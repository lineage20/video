...
<div class="admin">
    ...
    <div class="panel admin-panel">
    	<div class="panel-head"><strong>评论管理</strong></div>
        <div class="panel-body">
			<?php if(is_array($tree)): $i = 0; $__LIST__ = $tree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="media media-x">
					<a class="float-left" href="#">
						<img src="<?php echo ($list['user']['path']); ?>" width="64" height="64" class="radius" alt="<?php echo ($list['user']['username']); ?>">
					</a>
					<div class="media-body">
						<strong>影片名称：<a href="<?php echo U('home/movie/index',array('id'=>$list['mid']));?>" target="_blank"><?php echo ($list['movie_title']); ?></a></strong>
						<strong><?php echo ($list['user']['username']); ?> <?php echo (tmspan($list['create_time'])); ?> <div class="float-right"><a class="ajax-get" href="<?php echo U('Comment/del',"id=".$list['id']);?>">删除</a></strong></div><?php echo (ubb_face($list['content'])); ?>
						<hr />
					</div>
