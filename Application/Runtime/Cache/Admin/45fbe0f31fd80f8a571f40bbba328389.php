...
<div class="admin">
    ...
    <form method="post" class="form-x">
    	<div class="panel-head"><strong>幻灯管理</strong></div>
        ...
        <table class="table table-hover">
        	<tr>
           	...
           	<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php switch($vo['type']): case "1": ?>app<?php break; case "2": ?>wap<?php break; default: ?>web<?php endswitch;?></td>
                <td style="width:20%;"><img src="<?php echo (get_cover($vo['cover_id'],"path")); ?>" class="img-thumbnail" style="height:50px;"/></td>
				<td style="width:30%;"><?php echo ($vo["link"]); ?></td>
				<td style="width:15%;"><?php echo (time_format($vo["create_time"],"Y-m-d")); ?></td>
