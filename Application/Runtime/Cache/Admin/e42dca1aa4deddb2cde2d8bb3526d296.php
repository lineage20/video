    ...
    <form id="form">
        ...
        <div class="padding border-bottom">
        	<div class="button-group button-group-small">
             <button class="button ajax-get confirm" url="<?php echo U('clear');?>"><span class="icon-trash-o text-red"></span> 清空（保留一周日志）</button>
             </div>
        </div>
        <table class="table table-hover">
        	<tr>
           	...
           	<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo get_member_name($vo['user_id']);?></td>
                <td><?php echo (time_format($vo["create_time"])); ?></td>
                <td><?php echo long2ip($vo['action_ip']);?></td>
                <td style=" width:400px;word-break:break-all;"><?php echo ($vo["remark"]); ?></td>
